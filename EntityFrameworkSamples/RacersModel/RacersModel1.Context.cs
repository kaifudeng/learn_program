...
namespace RacersModel
{
    ...
    public partial class Formula1v2Entities : DbContext
    {
        public Formula1v2Entities()
            : base("name=Formula1v2Entities")
        {
        }
        ...
        public virtual DbSet<TeamsAndMotor> TeamsAndMotor { get; set; }
        public virtual DbSet<YearResults> YearResults { get; set; }
        public virtual DbSet<YearResultsTeam> YearResultsTeam { get; set; }
